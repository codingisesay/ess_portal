...
<head>
    ...
    <style>
        ...
        .sidebar-content ul li strong img {
            opacity: .58;
        }

        .sidebar-content ul li strong {
            color: #656565;
            display: flex;
            justify-content: space-between;
            align-items: center;
        ...
        /* Default styling for the <strong> */
        strong {
            color: black;
            font-weight: normal;
        }

        /* Apply style when any link inside the <li> has the 'active' class */
        li:has(.active)>strong {
            color: #8A3366 !important;
            /* Highlight color */
        }

        /* Style the strong element when any child link has the 'active' class */
        li:has(a.active)>strong strong {
            color: #8A3366 !important;
            /* Example text color */
            font-weight: bold;
        }

        /* Optional: Style for the default state */
        li>strong {
            ...
            <ul class="nav-list">
                ...
                <li>
                    <strong onclick="toggleDropdown('orgConfigDropdown', this)">
                        <strong> <i class="bi bi-gear"></i>&nbsp; Organisation Configuration</strong>
                ...
                <li>
                    <strong onclick="toggleDropdown('policyManagementDropdown', this)">
                        <strong> <i class="bi bi-gear"></i>&nbsp; Policy Management </strong>
                        <img src="{{ asset('user_end/images/arrow-right.svg') }}" alt="arrow" class="dropdown-arrow">
                    </strong>
                ...
                <li>
                    <strong onclick="toggleDropdown('salaryManagementDropdown', this)">
                        <strong> <i class="bi bi-gear"></i>&nbsp; Salary Management </strong>
                        <img src="{{ asset('user_end/images/arrow-right.svg') }}" alt="arrow"
                ...
                <li>
                    <strong onclick="toggleDropdown('taxManagementDropdown', this)">
                        <strong> <i class="bi bi-gear"></i>&nbsp; Tax Management </strong>
                        <img src="{{ asset('user_end/images/arrow-right.svg') }}" alt="arrow"
                            class="dropdown-arrow">
                    </strong>
