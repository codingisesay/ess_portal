...
function renderEmployeeTree($employees) {
    ...
    foreach ($employees as $employee) {
        ...
        echo '<div class="profile-container"><img src="' . (isset($employee->profile_image) && !empty($employee->profile_image) ? asset('storage/' . $employee->profile_image) : 'user_profile_image/Oqr4VRqo7RpQxnmiZCh12zybbcdsyUin2FhAKD3O.jpg') . '" alt="Profile Image" class="profile-img"></div>';
