                  ...
                  <div class="form-row">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" id="city_permanent" name="permanent_city" required maxlength="35"
                              ...
                              <label for="permanent_city">City/Town/Village<span style="color: red;" id="city-required">*</span></label>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" id="state_permanent" name="permanent_state" required maxlength="35"
                              ...
                              <label for="permanent_state">State/Province<span style="color: red;" id="state-required">*</span></label>
                      </div>
