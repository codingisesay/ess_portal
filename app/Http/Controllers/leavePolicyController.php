...
foreach ($workScheduleArray as $date => $details) {
    ...
    // dd($appliedLeaves);
        ...
        return view('user_view.leave_dashboard', compact('leaveSummary', 'workingHoursData', 'appliedLeaves', 'upcomingApprovedLeaves','title','holidays_upcoming', 'attendanceRate', 'presentDays', 'absentDays', 'totalDaysInMonth', 'attendanceOverview'));
    }
